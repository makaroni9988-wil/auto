...
input ENUM_TIMEFRAMES InpTF1_VisibleFrom = PERIOD_M1;    // 1st Visible from chart TF
input ENUM_TIMEFRAMES InpTF1_VisibleTo   = PERIOD_MN1;   // 1st Visible up to chart TF
...
input ENUM_TIMEFRAMES InpTF2_VisibleFrom = PERIOD_M1;    // 2nd Visible from chart TF
input ENUM_TIMEFRAMES InpTF2_VisibleTo   = PERIOD_MN1;   // 2nd Visible up to chart TF
